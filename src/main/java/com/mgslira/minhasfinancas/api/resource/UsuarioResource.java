package com.mgslira.minhasfinancas.api.resource;
...
import com.mgslira.minhasfinancas.api.dto.UsuarioDTO;
...
import com.mgslira.minhasfinancas.service.LancamentoService;
...
public class UsuarioResource {
	...
	public ResponseEntity obterSaldo( @PathVariable("id") Long id) {
		...
		BigDecimal saldo = lancamentoService.obterSaldoLancamentoUsuario(id);
